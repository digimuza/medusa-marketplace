...
import { useAdminAddProductsToSalesChannel, useAdminDeleteProductsFromSalesChannel, useAdminProducts } from 'medusa-react'
...
export const ProductTable = forwardRef((props: ProductTableProps, ref: React.Ref<any>) => {
	const {
		...
		productFilters: { setTab, saveTab, removeTab, availableTabs: filterTabs, activeFilterTab, setFilters, filters, reset },
		paginate,
