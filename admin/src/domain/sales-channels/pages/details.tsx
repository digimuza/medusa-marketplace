...
function ListIndicator(props: ListIndicatorProps) {
	...
	return (
		<div
			className={clsx('flex justify-center items-center flex-shrink-0 w-[18px] h-[18px] bg-white border rounded-circle', {
...
function Details() {
	...
	return (
		<div>
			<Breadcrumb currentPage={'Sales channels'} previousBreadcrumb={'Settings'} previousRoute="/a/settings" />
