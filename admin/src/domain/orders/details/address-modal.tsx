...
type MutateAction = <T extends TVariables>(variables: T, options?: MutateOptions<unknown, Error, unknown, unknown> | undefined) => void
...
const AddressModal = ({ address, allowedCountries = [], handleClose, submit, type, submitting = false }: AddressModalProps) => {
...
const mapAddressToFormData = (address?: Address): AddressPayload => {
	...
	return {
		...
		country_code: address?.country_code ? { label: countryDisplayName, value: address.country_code } : { label: '', value: '' },
