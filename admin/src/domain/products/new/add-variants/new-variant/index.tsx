...
import CreateFlowVariantForm, { CreateFlowVariantFormType } from '../../../components/variant-form/create-flow-variant-form'
...
const NewVariant = ({ id, source, index, save, remove, move, options, onCreateOption, productDimensions, productCustoms }: Props) => {
...
const VariantValidity = ({ source, productCustoms, productDimensions }: Pick<Props, 'source' | 'productCustoms' | 'productDimensions'>) => {
	const {
		prices,
		options,
		dimensions,
	...
	const validCustoms = Object.values(productCustoms).every((value) => !!value) || Object.values(customs).every((value) => !!value)
