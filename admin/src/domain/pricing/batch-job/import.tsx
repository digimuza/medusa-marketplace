...
function ImportPrices(props: ImportPricesProps) {
	...
	const progress = isPreprocessed ? (batchJob!.result?.advancement_count || 0) / (batchJob!.result?.count || 1) : undefined
	...
	const onSubmit = async () => {
		...
		notification('Success', 'Import confirmed for processing. Progress info is available in the activity drawer.', 'success')
		props.handleClose()
	}
