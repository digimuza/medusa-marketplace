...
const PriceListFormContext = React.createContext<{
	...
	handleSubmit: <T extends FieldValues>(submitHandler: SubmitHandler<T>) => (e?: React.BaseSyntheticEvent) => Promise<void>
} | null>(null)
...
export const PriceListFormProvider: React.FC<FormProviderProps> = ({ priceList = defaultState, children }) => {
	const [configFields, setConfigFields] = useState<Pick<PriceListFormValues, 'starts_at' | 'ends_at' | 'customer_groups'>>({
