...
import { CreatePriceListFormValues, CreatePriceListPricesFormValues, PriceListFormValues, PriceListStatus, PriceListType } from '../types'
...
export const mapFormValuesToUpdatePriceListDetails = (values: PriceListFormValues): AdminPostPriceListsPriceListPriceListReq => {
	return {
