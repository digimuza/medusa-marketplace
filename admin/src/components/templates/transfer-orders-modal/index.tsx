...
import { DisplayTotalAmount, FulfillmentStatusComponent, PaymentStatusComponent } from '../../../domain/orders/details/templates'
...
const TransferOrdersModal: React.FC<TransferOrdersModalProps> = ({ order, onDismiss }) => {
	...
	const getCustomerOption = (customer: { id: string; email: string; first_name?: string; last_name?: string }) => {
