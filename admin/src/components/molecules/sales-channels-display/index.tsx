	...
	return (
		<div className="flex flex-col gap-y-small">
			...
			<p className="inter-base-regular text-grey-50">
				Available in{' '}
				<span className="inter-base-semibold text-grey-90">{channels.length ? channels.length : 0}</span> out of{' '}
				<span className="inter-base-semibold text-grey-90">{count || 0}</span> Sales Channels
			</p>
		</div>
	)
}
