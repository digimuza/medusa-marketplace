...
Table.Head = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
	({ className, children, ...props }, ref) => (
		<thead
			ref={ref}
			className={clsx('whitespace-nowrap inter-small-semibold text-grey-50 border-t border-b border-grey-20', className)}
			{...props}
		>
			{children}
		</thead>
...
Table.Cell = React.forwardRef<HTMLTableCellElement, TableCellProps>(({ className, linkTo, children, ...props }, ref) => {
