import { useAdminCancelReturn, useAdminCancelSwap, useAdminOrder, useAdminReceiveReturn, useAdminStore } from 'medusa-react'
...
const Exchange: React.FC<ExchangeProps> = ({ event, refetch }) => {
	...
	if (!event.isCanceled && !event.canceledAt && event.fulfillmentStatus !== 'fulfilled' && event.fulfillmentStatus !== 'shipped') {
		actions.push({
