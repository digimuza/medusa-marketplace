...
const FastDeliveryIcon: React.FC<IconProps> = ({ size = '20', color = 'currentColor', ...attributes }) => {
	return (
		<svg width={size} height={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...attributes}>
			<path d="M3.02901 6.12695H2.25439" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M3.80363 3.8031H2.25439" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M13.8734 16.1969H3.02881" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path
			...
			/>
			<path d="M6.90088 10.7745H8.55081" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path
