...
const BatchJobActivityCard = (props: { batchJob: BatchJob }) => {
	...
	const onDownloadFile = async () => {
		...
		try {
			...
			notification('Error', `Something went wrong while downloading the ${operation.toLowerCase()} file`, 'error')
		}
	}
	...
	const onDeleteFile = async () => {
		...
		try {
			...
			notification('Error', `Something went wrong while deleting the ${operation.toLowerCase()} file`, 'error')
		}
	}
