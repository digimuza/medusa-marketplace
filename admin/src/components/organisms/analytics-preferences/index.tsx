				...
				<div className="flex flex-col items-center">
					<div className="mt-5xlarge flex flex-col max-w-[664px] w-full">
						...
						<p className="text-grey-50">
							To create the most compelling e-commerce experience we would like to gain insights
							in how you use Medusa. User insights allow us to build a better, more engaging, and
							more usable products. We only collect data for product improvements. Read what data
							we gather in our{' '}
							<a
