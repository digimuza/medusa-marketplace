					...
					{extraConfirmation && (
						<div className="flex flex-col my-base">
							<span className="mt-1 inter-base-regular text-grey-50">
								Type the name <span className="font-semibold">"{entityName}"</span> to
								confirm.
							</span>
							<InputField
								autoFocus={true}
...
const useImperativeDialog = () => {
	return ({ heading, text, confirmText, cancelText, extraConfirmation, entityName }: ImperativeDialogProps) => {
